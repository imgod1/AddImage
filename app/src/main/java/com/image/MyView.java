...
//把注释为111111的代码同时去掉，也是可以实现画图的
	public MyView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		mContext = context;
		mPath = new Path();
		mBitmapPaint = new Paint(Paint.DITHER_FLAG);//防抖动
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawBitmap(mBitmap, 0, 0, mBitmapPaint);//11111111111111111
